...
public class UiAutomationTrainingBasicTest extends TestBase {
	...
	public void testVerifyCheckBox() {
		...
		softAssert.assertTrue(CheckBoxPage.isCheckBoxPageDisplayed(), "Checkbox Page is not getting Displayed");
	...
	public void testVerifyDropDown() {
		...
		softAssert.assertTrue(DropDownPage.isDropDownDisplayed(), "Dropdown Page is not getting displayed");
	...
	public void testVerifyLogin() {
		...
		softAssert.assertTrue(LoginSecurePage.isLoginAlertDisplayed(), "Login Alert Message is not Displayed");
		...
		softAssert.assertTrue(LoginPage.isLogoutAlertDisplayed(), "Logout Alert Message is not Displayed");
		softAssert.assertTrue(LoginPage.getLogoutAlertMessage().contains(Constants.LOGOUT_SUCCESS_MSG), "Logout Alert Message is incorrect");
		softAssert.assertAll();
	}
	...
	public void testInvalidLogin(String username, String password) {
		...
		LoginPage.clickSubmit();
		softAssert.assertTrue(LoginPage.isLogoutAlertDisplayed(), "Login Invalid Message is not Displayed");
		softAssert.assertTrue(LoginPage.getLogoutAlertMessage().contains(Constants.LOGIN_INVALID_MSG), "Login Invalid Message is incorrect");
		softAssert.assertAll();
	}
}
